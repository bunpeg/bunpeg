# Bunpeg Media API Documentation

Welcome to the Bunpeg Media API documentation. This API provides a comprehensive set of tools for media processing operations using FFmpeg.

## Getting Started

The API is available at `https://api.bunpeg.io`. All endpoints support CORS and return JSON responses unless specified otherwise.
